package br.mendonca.spring02.controller;
...
import br.mendonca.spring02.repo.FornecedorRepo;
...
public class FornecedorController {
    ...
    public ResponseEntity<Fornecedor> cadastrar(@RequestBody Fornecedor novoFornecedor) {
        ...
        Fornecedor fornecedorCadastro = repo.save(novoFornecedor);

        return ResponseEntity.ok(fornecedorCadastro);
    }
}
